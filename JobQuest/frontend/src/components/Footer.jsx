      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold">Job Portal by Sarath Chandra</h2>
            <p className="text-sm">©MANIT </p>
          </div>
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            <a href="https://www.linkedin.com/in/yerraguntla-sarath-chandra-037835259/" target='_blank' className="hover:text-gray-400" aria-label="LinkedIn">
